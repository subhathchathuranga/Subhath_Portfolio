...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Subhath Chathuranga
          <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Software Engineer Intern</h3>
        <p className="home__description">I'm a passionate software developer skilled in front-end and back-end technologies like React, PHP, and MySQL. I enjoy building user-friendly, efficient web applications and always strive to learn and improve.</p>
